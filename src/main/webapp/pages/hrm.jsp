...
<body>
    ...
    <div class="content">
       ...
       <div id="employees-section" class="content-section hidden">
           ...
           <p>Click below to add a new employee:</p>
           <!-- Button to navigate to createEmployee page -->
           <button onclick="window.location.href='${pageContext.request.contextPath}/createEmployee'" class="menu-item">Add Employee</button>
           <button onclick="window.location.href='${pageContext.request.contextPath}/displayEmployee'" class="menu-item">display Employee</button>
       </div>
